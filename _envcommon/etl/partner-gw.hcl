...
# ---------------------------------------------------------------------------------------------------------------------
locals {
  source_base_url = "git::git@github.com:Furniture-com/fdc-aws-infra-catalog.git//modules/etl/partner-gardner-white-infra"
...
# ---------------------------------------------------------------------------------------------------------------------
inputs = {
  step_function_name                        = "gw-state-machine"
  gw_fetch_transform_data_lambda_name       = "gw-fetch-and-transform-feed"
  gw_store_transformed_data_lambda_name     = "gw-store-transformed-feed"
  gw_cleanup_lambda_name                    = "gw-cleanup"
