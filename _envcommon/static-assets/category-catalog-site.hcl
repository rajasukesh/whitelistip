...
# This is the common component configuration for static-assets/category-catalog-site. The common variables for each environment to
# deploy static-assets/category-catalog-site are defined here. This configuration will be merged into the environment configuration
...
terraform {
  source = "${local.source_base_url}?ref=v0.6.0-rc"
}
