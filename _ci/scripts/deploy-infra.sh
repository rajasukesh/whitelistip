#!/bin/bash
#
# Script used by jenkins to trigger infrastructure deployments via the infrastructure-deployer CLI utility on
...
readonly repo_url='https://github.com/Furniture-com/infrastructure-live.git'
...
function invoke_infrastructure_deployer {
  ...
  local -r ecs_deploy_runner_region='us-east-1'
