...
inputs = {
  ...
  # Name the stage with appropriately. Alphanumeric characters are allowed only.
  stage_name = "v1"
  ...
  stage_description = "v1 deployment to QA"

  # Specify the full arn of the aliased lambda functions if using it for provisioned concurrency
