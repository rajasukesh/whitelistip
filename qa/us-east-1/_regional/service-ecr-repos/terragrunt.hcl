...
locals {
  ...
  repos = {
    fdc-frontend = {
        external_account_ids_with_read_access = [local.common_vars.locals.account_ids.qa]
        external_account_ids_with_write_access = [local.common_vars.locals.account_ids.qa]
