...
- It is built for compliance with the CIS AWS Foundations Benchmark using the [Gruntwork CIS Service Catalog](https://github.com/gruntwork-io/terraform-aws-cis-service-catalog).- It's all defined and managed as code using tools such as [Terraform](https://www.terraform.io/), [Packer](https://www.packer.io/), and [Docker](https://www.docker.com/).
...
* **CIS Compliance**: see the [included CIS compliance docs](08-cis.md) for CIS Benchmark-specific information
