...
inputs = {
  ...
  stage_description = "v1 deployment to prod"
  ...
  lambda_function_names = [
    ...
    "arn:aws:lambda:us-east-1:${local.account_id}:function:get-geo-information:prod",
    "arn:aws:lambda:us-east-1:${local.account_id}:function:get-zip-by-location:prod",
    "arn:aws:lambda:us-east-1:${local.account_id}:function:get-rules-context:prod",
    "arn:aws:lambda:us-east-1:${local.account_id}:function:retool-update-products-service:prod"
  ]
