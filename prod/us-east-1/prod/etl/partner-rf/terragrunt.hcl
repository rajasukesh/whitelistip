...
inputs = {
  ...
  rf_parse_feed_lambda_reserved_concurrency     = 10
  ...
  force_destroy_bucket                          = false # Do not use in production
  ...
  trigger_schedule_expression = "cron(0 6 * * ? *)" # Runs at 06:00 a.m UTC everyday
