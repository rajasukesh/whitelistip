...
inputs = {
  ...
  iam_group_name    = "iam-user"
  iam_policy = {
    IamUserSelfManagementPermissionsThatDontRequireMFA = {
      actions= [
    ...
    IamUserSelfManagementPermissionsThatRequiresMFA = {
      actions= [
        "iam:CreateAccessKey",
        "iam:DeleteAccessKey",
  ...
  custom_iam_policy_name = "iam-user"
}