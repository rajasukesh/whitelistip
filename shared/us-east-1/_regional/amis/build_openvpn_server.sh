...
# https://github.com/gruntwork-io/terraform-aws-service-catalog/blob/v0.90.2/modules/mgmt/openvpn-server/openvpn-server-ubuntu.pkr.hcl
#
...
ami_account_ids="[\"$dev_account_id\",\"$prod_account_id\",\"$stage_account_id\", \"$qa_account_id\"]"
