...
inputs = {
  secret_policies = {
    GitHubPAT = {
      arn                           = "arn:aws:secretsmanager:us-east-1:980279442813:secret:MachineUserGitHubPAT-V7AWYW"
      iam_entities_with_read_access = local.accounts_to_share
      iam_entities_with_full_access = []
      policy_statement_json         = ""
    },
    SSHPrivateKey = {
      arn                           = "arn:aws:secretsmanager:us-east-1:980279442813:secret:MachineUserSSHPrivateKey-1QL6Je"
      iam_entities_with_read_access = local.accounts_to_share
      iam_entities_with_full_access = []
      policy_statement_json         = ""
    },
